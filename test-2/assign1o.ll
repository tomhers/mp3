...
declare %String* @String_substr(i32, i32)
declare %Int* @Int_new()
...
@Int_vtable_prototype = constant %Int_vtable {
	...
	%Int* (%Int*) * bitcast (%Object* (%Object*) * @Object_copy to %Object* (%Int*) *)
}
...
@Bool_vtable_prototype = constant %Bool_vtable {
	...
	%Bool* (%Bool*) * bitcast (%Object* (%Object*) * @Object_copy to %Object* (%Bool*) *)
}
...
@String_vtable_prototype = constant %String_vtable {
	...
	%String* (%String*) * bitcast (%Object* (%Object*) * @Object_copy to %Object* (%String*) *),
...
@IO_vtable_prototype = constant %IO_vtable {
	...
	%IO* (%IO*) * bitcast (%Object* (%Object*) * @Object_copy to %Object* (%IO*) *),
...
@Main_vtable_prototype = constant %Main_vtable {
	...
	%Main* (%Main*) * bitcast (%Object* (%Object*) * @Object_copy to %Object* (%Main*) *),
