...
@str.0 = internal constant [8 x i8] c"new1.cl\00", align 1
...
entry:
	...
	%tmp.6 = bitcast %Int* %tmp.5 to %Object*
	ret %Object* %tmp.6
...
entry:
	%tmp.7 = getelementptr %Main_vtable, %Main_vtable* @Main_vtable_prototype, i32 0, i32 1
	%tmp.8 = load i32, i32* %tmp.7
	%tmp.9 = call i8*(i32) @malloc( i32 %tmp.8 )
	%tmp.10 = bitcast i8* %tmp.9 to %Main*
	%tmp.11 = getelementptr %Main, %Main* %tmp.10, i32 0, i32 0
	store %Main_vtable* @Main_vtable_prototype, %Main_vtable** %tmp.11
	%tmp.12 = alloca %Main*
	store %Main* %tmp.10, %Main** %tmp.12
	%tmp.13 = getelementptr %Main, %Main* %tmp.10, i32 0, i32 1
	%tmp.14 = call %Int* @Int_new(  )
	%tmp.16 = getelementptr %Int, %Int* %tmp.14, i32 0, i32 1
	%tmp.15 = load i32, i32* %tmp.16
	store i32 %tmp.15, i32* %tmp.13
	ret %Main* %tmp.10
