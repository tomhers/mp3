...
@str.0 = internal constant [21 x i8] c"checkvoid_dynamic.cl\00", align 1
@String.0 = constant %String {
	%String_vtable* @String_vtable_prototype,
	i8* getelementptr ([21 x i8], [21 x i8]* @str.0, i32 0, i32 0)
}
...
ok.0:
	%tmp.5 = getelementptr %Foo, %Foo* %tmp.3, i32 0, i32 0
	%tmp.6 = load %Foo_vtable*, %Foo_vtable** %tmp.5
	%tmp.7 = getelementptr %Foo_vtable, %Foo_vtable* %tmp.6, i32 0, i32 7
	%tmp.8 = load %Object* (%Foo*) *, %Object* (%Foo*) ** %tmp.7
	%tmp.9 = call %Object*(%Foo*) %tmp.8( %Foo* %tmp.3 )
	ret %Object* %tmp.9
...
entry:
	%tmp.10 = getelementptr %Main_vtable, %Main_vtable* @Main_vtable_prototype, i32 0, i32 1
	%tmp.11 = load i32, i32* %tmp.10
	%tmp.12 = call i8*(i32) @malloc( i32 %tmp.11 )
	%tmp.13 = bitcast i8* %tmp.12 to %Main*
	%tmp.14 = getelementptr %Main, %Main* %tmp.13, i32 0, i32 0
	store %Main_vtable* @Main_vtable_prototype, %Main_vtable** %tmp.14
	%tmp.15 = alloca %Main*
	store %Main* %tmp.13, %Main** %tmp.15
	%tmp.16 = getelementptr %Main, %Main* %tmp.13, i32 0, i32 1
	store %Foo* null, %Foo** %tmp.16
	ret %Main* %tmp.13
