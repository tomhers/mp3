...
public:
	...
	// New fields
	vector<op_type> vtableTypes;
	vector<const_value> vtableValues;
	vector<string> vtableFuncNames;
	vector<op_type> myVtableTypes;
	vector<const_value> myVtableValues;
	vector<string> myVtableFuncNames;
	vector<string> myVtableReturnTypes;
